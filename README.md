...
1. Choose your AI Engine → Run Analysis  
   a). Flashmind Market for Market Analysis 
   b). RAG and Analysis engines for (Multi-Department Problem solving, Detailed analysis and Inovations)
   c). Finance/fin for Detailed Financial Analysis and Report.
   d). Product Development/Optimization with Omnicore Key for your product improvisation 

2. Toggle *Dark / Light mode* & download reports.

---

🔑 *API Keys* → ask for key
- Flashmind  
...
5 Whys, Fishbone (Ishikawa), SWOT, DMAIC, Porter’s 5 Forces, BCG Matrix, Iceberg Model, Pareto (80/20), 
Use : User-Defined (for Finance and Market Analysis)

⚙️ Engine Selection

# =============================
# Choose the right engine & method for your business case
# =============================

business_engines = [

    "a) Flashmind RAG + Product R&D, Optimization (Omnicore)  (fast, short and precise) → "
    "Supports Strategy across Marketing, Sales, HR & Innovations, and Supply Chain management.",

    "b) Flashmind Market for Market Analysis (User-defined Methodology) → "
    ...
    "e) Qwen + Omnicore Finance → "
    "Conducts Finance Analysis using User-defined Methodologies. "
    "For Tool plant and design setups, utilize Product-R&D-Omni workflows.",
...
Direct Input Tab → Type your problem, notes, or scenario.
File Upload Tab → Upload PDF, Word, or Excel documents (OCR-Enabled).


---

👥 Perspectives- Multi-stake holder perspective, change the angle (Bigger-Bird view & Clearer Picture Concept)
Harmony Assistant analyzes from both sides:
User (Manager / Requester) perspective
Doer (Stakeholders / Team) perspective
Use the Relevance Slider to prioritize whose inputs matter more (User vs. Doer).

---

▶️ Run Analysis
1. Hit Run Analysis.
2. Sit back while Harmony Assistant processes:
Quantified solutions , Latest industry examples, Contribution % of problems analyzed (benchmarked with top industry leaders), Strategic & management guidance
...
- Offline fallback  
- Quantified solutions & industry examples  
